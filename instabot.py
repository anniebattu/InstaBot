...
ACCESS_TOKEN = "1434567051.d488139.ecb4c55b651d4301acc8415653239b21"
BASE_URL = "https://api.instagram.com/v1/"


def self_info():
    """
    This function gets the instagram username,foolwer count,following count and no. of media of access token holder
    1.Make the URL
    2.Make the request
    """
...
def get_user_id(instagram_username):
    """
        This function gets the user id of other instagram user
        1.Make the URL
        2.Make the request
     """
...
def get_user_info(instagram_username):
    """
        This function gives you user's instagram name,followers count,following count and no. of posts
        1.Get the user id
        2.Make the URL
        3.Make the request
    """
...
def get_own_post():
    """
    This function helps to get the access tokn holder's images name along with URL.
...
def get_user_post(instagram_username):
    """
        This function helps to get other user's special image or all the images with their name along with URL .
        It also gives option for downloading
        1.Get the user id
        2.Make the url
        3.Make the request
...
def like_a_post(instagram_username):
    """
            This function helps to like instagram user's recent post
            1.Get the media id
            2.Make the URL
            3.Make the request
...
def calamity_check(latitude, longitude):
    """
    This function helps to find out te images in a parrticular geographical zone and through their caption analyses if it's a natural calamity.
    ...
    For testing purpose you can use coordinates 29.86444 and 77.89639 respectively
    """
...
again = True
print "Hello Buddy!! Welcome to InstaBot :)!"
while again:
    print "\n"
    ...
    print "11.Check if any images denote natural calamity in the area by using geographical coordinates"
    print "12.Exit"
    print "********************************"
    ...
    if choice == "1":
        ...
        calamity_check(latitude, longitude)
    elif choice == "12":
        again = False
        exit()
    else:
